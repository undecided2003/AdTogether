...
- **Android integration:** Implement `com.relaxsoftwareapps.adtogether:sdk:0.2.0` inside your `build.gradle.kts`.
- **iOS integration:** Add the Swift Package through Xcode directly from this repository link.
- **Flutter integration:** Run `flutter pub add adtogether_sdk:^0.2.0`.
