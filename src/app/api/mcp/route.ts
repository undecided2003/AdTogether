...
struct InterstitialExample: View {
    ...
    if (request.params.name === "check_sdk_version") {
      ...
      const latestVersions: Record<string, { version: string; changelog: string; upgradeCmd: string }> = {
        'web': {
          version: '0.2.6',
          changelog: '0.2.6: Fixed banner close button accessibility, improved dark mode detection.\n0.2.5: Added interstitial preloading support.\n0.2.4: Improved SDK initialization error messages.',
          upgradeCmd: 'npm install @adtogether/web-sdk@latest'
        },
        'react-native': {
          version: '0.2.6',
          changelog: '0.2.6: Fixed Android lifecycle crash on orientation change.\n0.2.5: Added iOS 18 support.\n0.2.4: Improved ad rendering performance.',
          upgradeCmd: 'npm install @adtogether/react-native-sdk@latest'
        },
        'android': {
          version: '0.3.0',
          changelog: '0.3.0: Migrated to Gradle 9.x, fixed PGP signing for Maven Central.\n0.2.6: Improved Compose composable lifecycle management.\n0.2.4: Initial stable release.',
          upgradeCmd: "Update your build.gradle.kts:\nimplementation(\"com.adtogether:sdk:0.3.0\")"
        },
        'flutter': {
          version: '0.2.6',
          changelog: '0.2.6: Improved AdTogetherBanner impression tracking accuracy.\n0.2.5: Fixed hot-reload state loss bug.\n0.2.4: Initial stable release.',
          upgradeCmd: "Update your pubspec.yaml:\nadtogether_sdk: ^0.2.6\nThen run: flutter pub get"
        }
      };
