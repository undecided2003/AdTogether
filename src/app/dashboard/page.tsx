...
import { Coins, Plus, Activity, LogOut, Globe, Image as ImageIcon, MousePointerClick, MapPin, Check } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-grow w-full max-w-6xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
        ...
        <div className="bg-gradient-to-br from-blue-900/40 to-black border border-blue-500/20 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-md font-medium text-zinc-300">Credits</h3>
          </div>
          <p className="text-4xl font-bold text-white mb-2">{userData?.credits || 0}</p>
          <p className="text-xs text-green-400/80 bg-green-400/10 inline-block px-2 py-1 rounded border border-green-400/20 truncate max-w-full">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-md font-medium text-zinc-300">Campaigns</h3>
          </div>
          <p className="text-4xl font-bold text-white mb-2">{ads.length}</p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-md font-medium text-zinc-300">Impressions</h3>
          </div>
          <p className="text-4xl font-bold text-white mb-2">{totalImpressions}</p>
          <p className="text-xs text-zinc-500">Network views</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-md font-medium text-zinc-300">Clicks</h3>
          </div>
          <p className="text-4xl font-bold text-white mb-2">{totalClicks}</p>
          <p className="text-xs text-zinc-500">Across campaigns</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-md font-medium text-zinc-300">CTR</h3>
          </div>
          <p className="text-4xl font-bold text-white mb-2">{ctr}%</p>
          <p className="text-xs text-zinc-500">Click-through rate</p>
        </div>
      </div>

      {/* Credit System Explanation */}
      <div className="mb-12 bg-blue-900/10 border border-blue-500/20 rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden relative">
        ...
        <div className="flex-grow z-10">
          <h3 className="text-lg font-bold text-white flex items-center gap-2 mb-2">
            <Coins className="w-5 h-5 text-blue-400" /> How Credits Work
          </h3>
          <p className="text-zinc-400 text-sm mb-4 md:mb-0">
            AdTogether is a fair, 1-to-1 ad exchange. Every time you show an ad in your app, you earn <strong className="text-blue-300">1 credit</strong>. Every time your ad is shown in someone else's app, you spend <strong className="text-blue-300">1 credit</strong>. 
          </p>
        </div>
        <div className="flex shrink-0 gap-4 z-10 w-full md:w-auto">
          <div className="bg-black/40 border border-white/10 rounded-xl px-4 py-3 flex-1 md:flex-none">
            <div className="text-green-400 text-sm font-semibold mb-1">+ Earn</div>
            <div className="text-zinc-400 text-xs text-balance">Integrate SDK & show ads</div>
          </div>
          <div className="bg-black/40 border border-white/10 rounded-xl px-4 py-3 flex-1 md:flex-none">
            <div className="text-blue-400 text-sm font-semibold mb-1">- Spend</div>
            <div className="text-zinc-400 text-xs text-balance">Your ads are shown globally</div>
          </div>
        </div>
      </div>
      ...
      {userData && (
        <div className="mb-12 bg-blue-500/5 border border-blue-500/20 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-blue-500/10 rounded-full text-blue-400">
              <MapPin className="w-6 h-6" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white">Targeting Profile</h3>
              <p className="text-sm text-zinc-400">
                Your ads show to users in similar demographics. Your current location is set to: <strong className="text-blue-300">{userData.country}</strong>
              </p>
            </div>
          </div>
            ...
            {editingCountry ? (
              <div className="flex gap-2 w-full">
                <select
                  ...
                  className="bg-black/50 border border-white/10 rounded-xl px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-xl transition flex items-center justify-center gap-2"
                >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-white/5 hover:bg-white/10 border border-white/10 text-white px-5 py-2.5 rounded-xl transition"
              >
      ...
      {showDocs && (
        <div className="mb-12 bg-white/5 border border-white/10 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-black/50 p-6 rounded-xl border border-white/5 flex flex-col">
              <h3 className="text-lg font-semibold text-blue-400 mb-3 flex-none">React / Next.js</h3>
              <CodeBlock 
                language="tsx"
...
/>`} 
            ...
            <div className="bg-black/50 p-6 rounded-xl border border-white/5 flex flex-col">
              <h3 className="text-lg font-semibold text-blue-400 mb-3 flex-none">Flutter</h3>
              <CodeBlock
                language="dart"
...
AdTogetherBanner(
  ...
  height: 80,
            ...
            <div className="bg-black/50 p-6 rounded-xl border border-white/5 flex flex-col">
              <h3 className="text-lg font-semibold text-blue-400 mb-3 flex-none">iOS (SwiftUI)</h3>
              <CodeBlock
                language="swift"
...
AdTogetherView(adUnitID: "home_banner")
    .frame(height: 80)`}
            ...
            <div className="bg-black/50 p-6 rounded-xl border border-white/5 flex flex-col">
              <h3 className="text-lg font-semibold text-blue-400 mb-3 flex-none">Android (View/XML)</h3>
              <CodeBlock
                language="kotlin"
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-zinc-400">👁 {ad.impressions || 0}   👆 {ad.clicks || 0}</span>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-white/5">
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`text-xs px-3 py-1.5 rounded transition ${ad.active ? 'bg-zinc-800 text-zinc-300 hover:bg-zinc-700' : 'bg-blue-600/20 text-blue-400 hover:bg-blue-600/30 border border-blue-500/20'}`}
                        >
                          {ad.active ? "Pause" : "Resume"}
                        </button>
                        <button
                          onClick={() => handleDeleteAd(ad.id)}
                          className="text-xs px-3 py-1.5 rounded bg-red-500/10 text-red-400 hover:bg-red-500/20 border border-red-500/20 transition"
                        >
                          Delete
                        </button>
                      </div>
                      <span className={`text-xs px-2 py-1 rounded border ${ad.active ? 'bg-green-500/10 text-green-400 border-green-500/20' : 'bg-zinc-800 text-zinc-500 border-white/10'}`}>
